...
class linearactuator():
    def __init__(self):
        ...
        self.R_PWM = GPIO.PWM(32,10000)   # Init pin 32 as pwm at 125 MHz
        self.L_PWM = GPIO.PWM(33,10000)   # init pin 33 as pwm at 125 MHz
    ...
    def stop(self):
        ...
        self.L_PWM.ChangeDutyCycle(0)           # set reverse pwm to
